        ...
        <div className="card">
          ...
          <div className="tiers">
            ...
            <TierCard
              ...
              description={
                <>
                  You&apos;re here. You&apos;re in the building. Every week
                  you&apos;ll get <strong>1–2 free plays</strong> on us.
                </>
              }
              subscribed={access.free}
            ...
            <TierCard
              ...
              description={
                <>
                  This is where the real action is. You get{" "}
                  <strong>ALL daily plays</strong> PLUS the{" "}
                  <strong>
                    Max Bet Play Of The Day included every single day
                  </strong>{" "}
                  — that&apos;s a $49.99/day pick built into your sub.
                </>
              }
              prices={[
                "$29.99 / 2 Days",
            ...
            <TierCard
              ...
              description={
                <>
                  Brand new.{" "}
                  <strong>Daily player prop picks</strong> with full
            ...
            <TierCard
              ...
              description={
                <>
                  The top tier. <strong>EVERYTHING</strong> included — all
                  plays, Max Bet POTD, AND Player Props. If you&apos;re
                  serious about this, this is where you belong.
                </>
              }
      ...
      {prices && (
        <div className="prices">
          {prices.map((p, i) => {
            const parts = p.split(" / ");
            return (
              <div className="price-pill" key={i}>
...
const styles = `
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .card {
    width: 680px;
    max-width: 100%;
    background: linear-gradient(165deg, #0d0d0d 0%, #111111 40%, #0d0d0d 100%);
    border-radius: 20px;
    overflow: hidden;
    position: relative;
    border: 1px solid rgba(255,215,0,0.15);
    box-shadow: 0 0 80px rgba(255,215,0,0.06), 0 40px 80px rgba(0,0,0,0.6);
  }
  ...
  .header {
    ...
    background: radial-gradient(ellipse at center top, rgba(255,215,0,0.07) 0%, transparent 70%);
  }
  ...
  .tier-subscribed::after {
    content: '';
    position: absolute;
    inset: 0;
    border-radius: 14px;
    border: 2px solid rgba(45,125,70,0.5);
    pointer-events: none;
    z-index: 2;
  }
